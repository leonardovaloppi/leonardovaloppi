...
<table>
  <tr>
    <td align="left" valign="middle" width="100%">
      <ul>
          <br>
      📝 &nbsp <b>Spreadsheets</b> → Excel & Google Sheets <br> 
          <br>
      💾 &nbsp <b>Data cleaning and manipulation</b> → SQL (Google BigQuery)  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <br>
          <br>
      📊 &nbsp <b>Data visualization and reporting</b> → Tableau  <br>
          <br>
      🐍 &nbsp <b>Python</b> → Pandas, Matplotlib, Plotly, Scikit-learn <br>
          <br>
      </ul>
    <td width="100%">
